...
ulong test_1(const std::string &query) { return pipeline_example(query); }
...
int main() {
    ...
    const auto expected_result_test_1 = get_expected_value();
    const auto actual_result_test_1 = test_1(query);
