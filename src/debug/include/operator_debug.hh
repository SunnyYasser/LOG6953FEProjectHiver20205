...
namespace VFEngine {
    ...
    private:
        void create_logfile();
        std::string get_operator_type_as_string(operator_type_t type) const;
        [[nodiscard]] std::string get_operator_name_as_string(operator_type_t type, const std::string &uuid) const;
