...
ROUTING_KEY_CLICKED = "propagation.affected.buildings"  # Must match the routing key from Godot
ROUTING_KEY_AFFECTED = "propagation.neo4j.results"  # The new routing key for sending affected buildings
...
def callback(ch, method, properties, body):
    ...
    # Send this list to the 'propagation.<DBType>.results' routing key
...
def send_affected_buildings(data):
    ...
    # Publish the message to 'propagation.<DBType>.results'
...
print("🔄 Waiting for 'propagation.affected.buildings' messages... Press CTRL+C to exit.")
